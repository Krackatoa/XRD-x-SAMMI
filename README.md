...
Step 6 (Optional): Copy the XrdDemoDeck.txt in the repo to your clipboard, and you can import it to Sammi via the Paste Deck command. You'll have to add two `Trigger Button` commands included in the `Gamestate Triggers (Required)` button to your `Xrd_Triggers` button in the Extension Deck.
